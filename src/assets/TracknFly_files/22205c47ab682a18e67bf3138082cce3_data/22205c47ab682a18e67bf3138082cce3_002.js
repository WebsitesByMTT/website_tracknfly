...
if (("performance" in window) && ("currentScript" in document)) {
  window.TP_PERF_METRICS.entrypoint("22205c47ab682a18e67bf3138082cce3", "mewtwo");
  window.TP_PERF_METRICS.addResourceById("22205c47ab682a18e67bf3138082cce3", document.currentScript.src);
}
...
(function () {
  var initialized_attr = "initialized",
      target_src = function(){ return "https://www.travelpayouts.com/widgets_static/22205c47ab682a18e67bf3138082cce3.js" },
      ref = document.getElementsByTagName('script'),
      trace_id = 'Zz1813cbf88df548bdbfedeba-368154',
      promo_id = 4237;

  if (window.mewtwo) {
    window.mewtwo["22205c47ab682a18e67bf3138082cce3"] = window.mewtwo["22205c47ab682a18e67bf3138082cce3"] ? window.mewtwo["22205c47ab682a18e67bf3138082cce3"] : {};
   } else {
    window.mewtwo =  {"22205c47ab682a18e67bf3138082cce3" : {} };
  }
  window.mewtwo["22205c47ab682a18e67bf3138082cce3"].trace_id  = window.mewtwo["22205c47ab682a18e67bf3138082cce3"].trace_id ?  window.mewtwo["22205c47ab682a18e67bf3138082cce3"].trace_id  : [];
  window.mewtwo["22205c47ab682a18e67bf3138082cce3"].trace_id.push('Zz1813cbf88df548bdbfedeba-368154');
  window.mewtwo["22205c47ab682a18e67bf3138082cce3"].promo_id = 4237


  for (var i = 0, len = ref.length; i < len; i++) {
    var script = ref[i];
    var src = script.getAttribute('src');
    var matches = src && src.match(/\/widgets\/22205c47ab682a18e67bf3138082cce3(.*)\.js/);
    ...
    if (src && !script.getAttribute('script-initialized') && matches && src.split('/').length < 6) {
      ...
      if (("performance" in window) && ("currentScript" in document)) {
        window.TP_PERF_METRICS.addResourceById("22205c47ab682a18e67bf3138082cce3", js.src);
      }
      script.parentNode.insertBefore(js, script);
      var url = "//avsplow.com/a/j.gif?p=web&tv=pixel&e=se&aid=tp_widgets&se_ca=mewtwo&se_ac=proxy_init&co=%7B%22schema%22%3A%22contexts%22%2C%22data%22%3A%5B%7B%22schema%22%3A%22event%22%2C%22data%22%3A%7B%22widget_id%22%3A%2222205c47ab682a18e67bf3138082cce3%22%2C%22trace_id%22%3A%22Zz1813cbf88df548bdbfedeba-368154%22%2C%22promo_id%22%3A%224237%22%7D%7D%5D%7D";
...
/*! link: /mewtwo/styles.css?v=h001 */
/*! link: /widgets_static/22205c47ab682a18e67bf3138082cce3.js?v=h001 */