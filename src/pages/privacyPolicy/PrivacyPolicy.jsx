    ...
    <div className={styles.privacyPolicy}>
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.publishedAt}>Last updated: January 18, 2024</p>
            ...
            <div className={styles.para}>
              ...
              <ul>
                ...
                <li>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Tracknfly.
                </li>
                <li>
                ...
                <li>
                  <span>Country</span> refers to: Texas, United States
                </li>
                <li>
                ...
                <li>
                  <span>Service</span> efers to the Website.
                </li>
                <li>
                ...
                <li>
                  <span>Website</span> refers to Tracknfly, accessible from{" "}
                  <a href="https://www.tracknfly.com/">
                    https://www.tracknfly.com/
                  </a>
                </li>
                <li>
          ...
          <div className={styles[`content-container`]}>
            ...
            <div className={styles.para}>
              ...
              <ul>
                ...
                <li>
                  <span>For business transfers:</span> We may share or transfer
        ...
        <div className={styles.content}>
          ...
          <div className={styles[`content-container`]}>
            ...
            <div className={styles.para}>
              ...
              <ul>
                <li>By email: contact@tracknfly.com</li>
              </ul>
            </div>
          </div>
        </div>
