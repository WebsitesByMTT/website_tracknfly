    ...
    <>
      ...
      <div className="py-5">
        ...
        <div className="text-black text-[1.5rem] text-center w-full tracking-wide py-5 md:w-[70%] mx-auto">
          ...
          booking car rental, or anything regarding the website, we are here to
        ...
        <div className="text-black text-[1.5rem] text-center w-full tracking-wide pt-5 pb-10 md:pb-20 md:w-[70%] mx-auto">
          ...
          cars on rent. We also send notifications to our customers so that they
          can get the best deal at the right time. So, now you don’t have to
          increase your bucket list and plan your trip now with Trackn Fly
          exclusive offers.
        </div>
