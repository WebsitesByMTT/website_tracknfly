      ...
      <div className="Container py-[7rem] flex flex-col gap-[7rem]">
        <div className="px-[2rem] md:px-[4rem] flex items-center justify-center flex-col gap-[1rem] ">
          ...
          <p className=" text-[2rem] w-full md:w-[80%] text-center">
            ...
            any time with our expert team via phone and email. They will ensure
            you have a smooth experience because your satisfaction is the top
            most priority.
          </p>
        </div>
            ...
            <ul className=" flex flex-row gap-[2rem]">
              {social.map((item) => (
                <li key={item?.id} className=" cursor-pointer">
                  <Link to={item?.url}>
                    <img src={item?.logo} className=" w-[3.5rem] h-[3.5rem]" />
                  </Link>
                </li>
              ))}
            </ul>
