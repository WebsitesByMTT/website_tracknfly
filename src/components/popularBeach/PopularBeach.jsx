    ...
    <div className="bg-[#F5F5F5]">
      <div className="py-24 px-[4rem] mx-auto flex flex-col gap-[4rem]">
        ...
        <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[4rem]">
          {data.map((item, idx) => (
            <div
              className=" p-[2rem] flex flex-col items-start justify-center gap-[1rem] rounded-2xl bg-[white]"
              key={idx}
              style={{ boxShadow: "0px 4.43px 17.71px 0px #9E9E9E40" }}
            >
              <div className=" flex flex-col gap-[1rem]">
                <span className=" text-[gray] text-[1.6rem]">{item.date}</span>
                <div className=" ml-3">
                ...
                <span className="text-[gray] text-[1.6rem] font-normal">
                  {item.discount}
                </span>
              </div>
