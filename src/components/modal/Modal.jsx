    ...
    <div className="fixed inset-0  flex items-center justify-center z-[9999]">
      ...
      <div className="relative z-50 w-[90%] lg:w-[60%] 2xl:w-[40%]  rounded-lg">
        ...
        <div className='absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
          <div className='uppercase text-white  mx-auto font-bold text-[1.2rem] md:text-[1.6rem] lg:text-[2.1rem]  text-center'>You can freely contact us for exclusive deals and offers</div>
